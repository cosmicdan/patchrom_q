.class public Lcom/android/settingsstock/net/UidDetailProvider;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/settingsstock/net/UidDetailProvider;->mContext:Landroid/content/Context;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, Lcom/android/settingsstock/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
...
.method private buildUidDetail(I)Lcom/android/settingsstock/net/UidDetail;
    .locals 18

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/settingsstock/net/UidDetailProvider;->mContext:Landroid/content/Context;
    ...
    new-instance v3, Lcom/android/settingsstock/net/UidDetail;

    invoke-direct {v3}, Lcom/android/settingsstock/net/UidDetail;-><init>()V
    ...
    iput-object v14, v3, Lcom/android/settingsstock/net/UidDetail;->label:Ljava/lang/CharSequence;

    invoke-virtual {v10}, Landroid/content/pm/PackageManager;->getDefaultActivityIcon()Landroid/graphics/drawable/Drawable;

    move-result-object v14

    iput-object v14, v3, Lcom/android/settingsstock/net/UidDetail;->icon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v12, v5, v11}, Lcom/android/settingsstock/users/UserUtils;->getUserIcon(Landroid/os/UserManager;Landroid/content/pm/UserInfo;Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v2}, Lcom/android/settingsstock/Utils;->getTetheringLabel(Landroid/net/ConnectivityManager;)I
    ...
    :cond_3
    :goto_3
    iget-object v14, v3, Lcom/android/settingsstock/net/UidDetail;->label:Ljava/lang/CharSequence;
    ...
    iput-object v14, v3, Lcom/android/settingsstock/net/UidDetail;->detailLabels:[Ljava/lang/CharSequence;
    ...
    iget-object v14, v3, Lcom/android/settingsstock/net/UidDetail;->detailLabels:[Ljava/lang/CharSequence;
...
.method public clearCache()V
    ...
    iget-object v1, p0, Lcom/android/settingsstock/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcom/android/settingsstock/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
...
.method public getUidDetail(IZ)Lcom/android/settingsstock/net/UidDetail;
    .locals 3

    iget-object v2, p0, Lcom/android/settingsstock/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
    ...
    check-cast v0, Lcom/android/settingsstock/net/UidDetail;
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcom/android/settingsstock/net/UidDetailProvider;->buildUidDetail(I)Lcom/android/settingsstock/net/UidDetail;
