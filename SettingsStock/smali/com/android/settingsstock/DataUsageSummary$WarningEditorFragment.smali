.class public Lcom/android/settingsstock/DataUsageSummary$WarningEditorFragment;
...
.method public static show(Lcom/android/settingsstock/DataUsageSummary;)V
    ...
    new-instance v1, Lcom/android/settingsstock/DataUsageSummary$WarningEditorFragment;

    invoke-direct {v1}, Lcom/android/settingsstock/DataUsageSummary$WarningEditorFragment;-><init>()V

    invoke-virtual {v1, v0}, Lcom/android/settingsstock/DataUsageSummary$WarningEditorFragment;->setArguments(Landroid/os/Bundle;)V

    const/4 v2, 0x0

    invoke-virtual {v1, p0, v2}, Lcom/android/settingsstock/DataUsageSummary$WarningEditorFragment;->setTargetFragment(Landroid/app/Fragment;I)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/settingsstock/DataUsageSummary$WarningEditorFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0}, Lcom/android/settingsstock/DataUsageSummary$WarningEditorFragment;->getActivity()Landroid/app/Activity;

    move-result-object v7

    invoke-virtual {p0}, Lcom/android/settingsstock/DataUsageSummary$WarningEditorFragment;->getTargetFragment()Landroid/app/Fragment;
    ...
    invoke-virtual {p0}, Lcom/android/settingsstock/DataUsageSummary$WarningEditorFragment;->getArguments()Landroid/os/Bundle;
    ...
    new-instance v0, Lcom/android/settingsstock/DataUsageSummary$WarningEditorFragment$1;

    move-object v1, p0

    invoke-direct/range {v0 .. v5}, Lcom/android/settingsstock/DataUsageSummary$WarningEditorFragment$1;-><init>(Lcom/android/settingsstock/DataUsageSummary$WarningEditorFragment;Landroid/widget/NumberPicker;Lcom/android/settingsstock/net/NetworkPolicyEditor;Landroid/net/NetworkTemplate;Lcom/android/settingsstock/DataUsageSummary;)V
