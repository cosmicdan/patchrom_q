.class Lcom/android/settingsstock/bluetooth/BluetoothEventManager$BondStateChangedHandler;
...
.method private constructor <init>(Lcom/android/settingsstock/bluetooth/BluetoothEventManager;)V
    ...
    iput-object p1, p0, Lcom/android/settingsstock/bluetooth/BluetoothEventManager$BondStateChangedHandler;->this$0:Lcom/android/settingsstock/bluetooth/BluetoothEventManager;
...
.method synthetic constructor <init>(Lcom/android/settingsstock/bluetooth/BluetoothEventManager;Lcom/android/settingsstock/bluetooth/BluetoothEventManager$1;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/settingsstock/bluetooth/BluetoothEventManager$BondStateChangedHandler;-><init>(Lcom/android/settingsstock/bluetooth/BluetoothEventManager;)V
...
.method private showUnbondMessage(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    :goto_1
    invoke-static {p1, p2, v0}, Lcom/android/settingsstock/bluetooth/Utils;->showError(Landroid/content/Context;Ljava/lang/String;I)V
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;Landroid/bluetooth/BluetoothDevice;)V
    ...
    iget-object v5, p0, Lcom/android/settingsstock/bluetooth/BluetoothEventManager$BondStateChangedHandler;->this$0:Lcom/android/settingsstock/bluetooth/BluetoothEventManager;
    ...
    invoke-virtual {v5}, Lcom/android/settingsstock/bluetooth/BluetoothEventManager;->readPairedDevices()Z
    ...
    invoke-static {v5}, Lcom/android/settingsstock/bluetooth/BluetoothEventManager;->access$1100(Lcom/android/settingsstock/bluetooth/BluetoothEventManager;)Ljava/util/Collection;
    ...
    check-cast v2, Lcom/android/settingsstock/bluetooth/BluetoothCallback;

    invoke-interface {v2, v1, v0}, Lcom/android/settingsstock/bluetooth/BluetoothCallback;->onDeviceBondStateChanged(Lcom/android/settingsstock/bluetooth/CachedBluetoothDevice;I)V
    ...
    invoke-virtual {v1, v0}, Lcom/android/settingsstock/bluetooth/CachedBluetoothDevice;->onBondingStateChanged(I)V
    ...
    invoke-static {p1, v5}, Lcom/android/settingsstock/bluetooth/LocalBluetoothPreferences;->removeDockAutoConnectSetting(Landroid/content/Context;Ljava/lang/String;)V

    invoke-virtual {p3}, Landroid/bluetooth/BluetoothDevice;->getAddress()Ljava/lang/String;

    move-result-object v5

    #calls: Lcom/android/settingsstock/bluetooth/BluetoothEventManager;->getDockedDeviceAddress(Landroid/content/Context;)Ljava/lang/String;
    invoke-static {p1}, Lcom/android/settingsstock/bluetooth/BluetoothEventManager;->access$1500(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v5, v4}, Lcom/android/settingsstock/bluetooth/BluetoothEventManager$BondStateChangedHandler;->showUnbondMessage(Landroid/content/Context;Ljava/lang/String;I)V
